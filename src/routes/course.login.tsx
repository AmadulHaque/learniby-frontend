...
export const Route = createFileRoute("/course/login")({
  component: LoginPage,
});
...
function LoginPage() {
  ...
  if (user) return <Navigate to="/course" />;
      ...
      <div className="relative z-10 grid w-full max-w-5xl gap-6 lg:grid-cols-2">
        ...
        <Card className="relative z-10 border-2 p-7 shadow-[var(--shadow-elegant)] sm:p-9">
          ...
          <p className="mt-4 text-center text-sm">
            <Link to="/course/forgot-password" className="font-semibold text-muted-foreground hover:text-primary hover:underline underline-offset-4">
          ...
          <p className="mt-5 text-center text-sm">
            নতুন একাউন্ট?{" "}
            <Link to="/course/register" className="font-bold text-primary underline-offset-4 hover:underline">
              রেজিস্ট্রেশন করুন
            </Link>
          </p>
        </Card>
