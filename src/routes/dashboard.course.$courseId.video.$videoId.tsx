        ...
        {video === undefined ? (
          ...
          <>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              {prev ? (
                <Link to="/dashboard/course/$courseId/video/$videoId" params={{ courseId, videoId: prev.id }}>
              ...
              {next ? (
                <Link to="/dashboard/course/$courseId/video/$videoId" params={{ courseId, videoId: next.id }}>
