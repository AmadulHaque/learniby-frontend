...
export const Route = createFileRoute("/course/course/$courseId")({
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="mx-auto max-w-4xl px-4 py-6">
        <Link to="/course" className="mb-5 inline-flex items-center gap-1.5 rounded-full border-2 border-border bg-card px-3 py-1.5 text-xs font-bold text-muted-foreground transition hover:border-primary/40 hover:text-primary">
