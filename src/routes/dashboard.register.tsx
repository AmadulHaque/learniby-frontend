import { defineRoute, Navigate, Link, useNavigate } from "@/lib/router-compat";
...
export const Route = defineRoute("/dashboard/register")({
...
function RegisterPage() {
  ...
  if (user && !done) return <Navigate to="/dashboard" />;
      ...
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background p-4">
        ...
        <Card className="relative z-10 w-full max-w-md border-2 p-8 text-center shadow-[var(--shadow-elegant)]">
          ...
          <Button
            ...
            onClick={() => navigate({ to: "/dashboard/login" })}
          >
            লগইন পেজে যান →
          </Button>
        </Card>
    ...
    <div className="relative min-h-screen overflow-hidden bg-background p-4 py-10">
      ...
      <Card className="relative z-10 mx-auto w-full max-w-lg border-2 p-7 shadow-[var(--shadow-elegant)] sm:p-9">
        ...
        <div className="text-center">
          <p className="text-xs font-bold uppercase tracking-widest text-primary">নতুন একাউন্ট</p>
        ...
        <p className="mt-7 text-center text-sm">
          ...
          <Link to="/dashboard/login" className="font-bold text-primary underline-offset-4 hover:underline">লগইন করুন</Link>
        </p>
      </Card>
    </div>
  );
